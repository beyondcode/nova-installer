...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        searchPackages: function searchPackages() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('https://novapackages.com/api/search?q=' + this.searchText).then(function (_ref) {
                var data = _ref.data;

                _this.availablePackages = data.data;
            });
        },
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return Nova.request().get('https://novapackages.com/api/recent');
        ...
        installPackage: function installPackage(selectedPackage) {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/beyondcode/nova-installer/install', {
                package: selectedPackage.composer_name
            }).then(function (_ref3) {
                var data = _ref3.data;

                _this2.$parent.$refs['nova-installer-navigation'].tools = data.tools;
                _this2.$parent.$refs['nova-installer-navigation'].scripts = data.scripts;
                _this2.$parent.$refs['nova-installer-navigation'].styles = data.styles;
                _this2.isInstalling = false;
                _this2.installingPackage = null;
                _this2.$toasted.show('Successfully installed ' + selectedPackage.name + '.', { type: 'success' });
            }).catch(function (_ref4) {
                var data = _ref4.data;

                _this2.isInstalling = false;
                _this2.installingPackage = null;
                _this2.$toasted.show('There was an error when trying to install ' + selectedPackage.name + '. Please take a look at your log files.', { type: 'error' });
            });
        }
    },
                      ...
                      _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            [
                              _vm.isInstalling &&
                              _vm.installingPackage === package.composer_name
                                ? _c("loader", { staticClass: "text-60" })
                                : _vm._e(),
                              _vm._v(" "),
                              !_vm.isInstalling ||
                              _vm.installingPackage !== package.composer_name
                                ? _c("span", [_vm._v("Install Package")])
                                : _vm._e()
                            ],
                            1
                          )
