...
Nova.booting(function (Vue, router) {
    ...
    Vue.component('nova-installer-navigation', __webpack_require__(14));
...
var update = __webpack_require__(3)("71c0e198", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d456e682\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Navigation.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d456e682\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Navigation.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    watch: {
        scripts: function scripts(val) {
            for (var scriptName in val) {
    ...
    methods: {
        transformed: function transformed(html) {
            return {
                template: html,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__InstalledPackages__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__InstalledPackages___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__InstalledPackages__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__PackageModal__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__PackageModal___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__PackageModal__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_tabs_component__ = __webpack_require__(66);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        Tabs: __WEBPACK_IMPORTED_MODULE_4_vue_tabs_component__["Tabs"],
        Tab: __WEBPACK_IMPORTED_MODULE_4_vue_tabs_component__["Tab"],
        InstalledPackages: __WEBPACK_IMPORTED_MODULE_2__InstalledPackages___default.a,
        PackageModal: __WEBPACK_IMPORTED_MODULE_3__PackageModal___default.a
    },
    ...
    methods: {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return Nova.request().get('/nova-vendor/beyondcode/nova-installer/packages/recent');
                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return Nova.request().get('/nova-vendor/beyondcode/nova-installer/packages/installed');

                            case 2:
                                response = _context2.sent;


                                this.installedPackages = Array.from(Object.keys(response.data), function (k) {
        ...
        status: function status() {
            ...
            __WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/nova-vendor/beyondcode/nova-installer/composer-status').then(function (response) {

                _this4.composerStatus = response.data;
                _this4.console = _this4.composerStatus.log;
        ...
        clearNotificationsAfter: function clearNotificationsAfter(milliseconds) {
        ...
        clearNotificationsNow: function clearNotificationsNow() {
            this.$toasted.clear();
        },
        initialStatusCheck: function initialStatusCheck() {
            var _this5 = this;

            Nova.request().get('/nova-vendor/beyondcode/nova-installer/composer-status').then(function (response) {

                _this5.composerStatus = response.data;

                if (_this5.composerStatus.is_running) {

                    _this5.isInstalling = true;
                    _this5.installingPackage = _this5.composerStatus.package;

                    _this5.$toasted.show('Installing "' + _this5.composerStatus.packageName + '"', { type: 'info', duration: 0 });
        ...
        isInstalled: function isInstalled(currentPackage) {
            ...
            return this.installedPackages.map(function (i) {
                return i.name;
            }).includes(currentPackage.composer_name);
        }
    },
...
Component.options.__file = "resources/js/components/InstalledPackages.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-dee5efa8", Component.options)
  } else {
    hotAPI.reload("data-v-dee5efa8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("f42172b6", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dee5efa8\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./InstalledPackages.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-dee5efa8\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./InstalledPackages.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        filteredInstalledPackages: function filteredInstalledPackages() {
            ...
            return this.installedPackages.filter(function (novaPackage) {
      ...
      _c(
        ...
        [
          _c("heading", { staticClass: "mb-6 mt-6" }, [
            _vm._v(
              "Installed Packages (" +
                _vm._s(this.installedPackages.length) +
                ")"
            )
          ])
        ],
        ...
        _c("div", { staticClass: "overflow-hidden overflow-x-auto relative" }, [
          _c(
            ...
            [
              ...
              _c(
                "tbody",
                _vm._l(_vm.filteredInstalledPackages, function(package, index) {
                  return _c(
                    "tr",
                    { key: index },
                    _vm._l(_vm.fields, function(field) {
...
Component.options.__file = "resources/js/components/PackageModal.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5c5caa72", Component.options)
  } else {
    hotAPI.reload("data-v-5c5caa72", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Modal__ = __webpack_require__(53);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_clickaway__ = __webpack_require__(55);
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "modal fixed pin flex justify-center items-center z-50" },
    [
      _c(
        "div",
        {
          staticClass:
            "relative z-20 bg-white rounded-lg shadow-lg overflow-hidden"
        },
        [_vm._t("default")],
        2
      ),
      _vm._v(" "),
      _c("div", {
        staticClass: "absolute pin bg-80 z-0 opacity-25",
        on: { click: _vm.close }
      })
    ]
  )
  ...
  return _c(
    ...
    [
      _c("heading", { staticClass: "mb-6" }, [
        _vm._v("Nova Package Installer")
      ]),
      _vm._v(" "),
      _c(
        "tabs",
        [
          _c("tab", { attrs: { name: "Install Packages" } }, [
            _c("div", { staticClass: "flex justify-between w-full" }, [
              _c(
                "div",
                { staticClass: "relative h-9 flex items-center mb-6 w-full" },
                [
                  _c("icon", {
                    staticClass: "absolute ml-3 text-70",
                    attrs: { type: "search" }
                  ...
                  _c("input", {
                    ...
                    staticClass:
                      "appearance-none form-control form-input w-search pl-search w-full",
                    attrs: { placeholder: "Search Packages", type: "search" },
            ...
            _c(
              "div",
              {
                staticClass: "flex items-center flex-no-shink flex-wrap -mx-3"
              },
              _vm._l(_vm.availablePackages, function(package) {
                return _c(
                  "div",
                  {
                    staticClass:
                      "w-1/4 px-3 flex flex-wrap justify-center sm:justify-start"
                  },
                  [
                    _c(
                      "div",
                      {
                        staticClass:
                          "flex mb-4 shadow hover:shadow-md h-128 w-full",
                      ...
                      [
                        _c(
                          ...
                          {
                            staticClass:
                              "flex-1 bg-white text-sm border-solid border-t-4 rounded-sm border-indigo"
                          },
                          [
                            _c(
                              "div",
                              ...
                              [
                                _c("div", { staticClass: "pb-2" }, [
                                  _c(
                                    ...
                                    {
                                      staticClass:
                                        "text-xl text-grey-darkest mb-2"
                                    },
                            ...
                            _c(
                              ...
                              {
                                staticClass:
                                  "bg-grey-lighter flex text-sm border-t px-6 py-4 items-center"
                              },
                              [
                                _c(
                                  "p",
                                  ...
                                  [_vm._v(_vm._s(package.author.name))]
                                ),
                                _vm._v(" "),
                                _vm.isInstalled(package)
                                  ? _c(
          ...
          _c(
            ...
            [
              _vm.showingPackage
                ? _c("PackageModal", {
                    attrs: {
                      selectedPackage: _vm.showingPackage,
                      isInstalling: _vm.isInstalling,
